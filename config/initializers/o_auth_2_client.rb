Concierge::Announcer.on(Concierge::OAuth2Client::ON_REQUEST) do |http_method, url, query_string, headers, body|
...
Concierge::Announcer.on(Concierge::OAuth2Client::ON_RESPONSE) do |status, headers, body|
...
Concierge::Announcer.on(Concierge::OAuth2Client::ON_FAILURE) do |message|
...
Concierge::Announcer.on(Concierge::OAuth2Client::ON_TOKEN_REQUEST) do |client, strategy|
...
Concierge::Announcer.on(Concierge::OAuth2Client::ON_TOKEN_RECEIVED) do |access_token|
