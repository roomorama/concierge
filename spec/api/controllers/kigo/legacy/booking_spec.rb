...
RSpec.describe API::Controllers::Kigo::Legacy::Booking do
  ...
  describe "#call" do
    ...
    it "returns proper error if external request failed" do
      ...
      expect_any_instance_of(Kigo::Legacy).to receive(:book).and_return(erred_reservation)
    ...
    it "returns a booking code when successful" do
      ...
      expect_any_instance_of(Kigo::Legacy).to receive(:book).and_return(reservation)
