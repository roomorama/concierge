module JTB
  module Sync
    module DB
      # +JTB::Sync::RoomPricesActualizer+
      #
      # Class responsible for actualizing DB jtb_room_prices table
      class RoomPricesActualizer < BaseActualizer

        FILE_PREFIX = 'RoomPrice'
        ...
        def repository
          JTB::Repositories::RoomPriceRepository
        end
